...
sales = []
thread_sold = []
for purchases in transactions_clean:
  customers.append(purchases[0])
  sales.append(purchases[1])
  thread_sold.append(purchases[2])
...
def color_count(color):
  ...
  for thread_color in thread_sold_split:
    if color == thread_color:
      color_count += 1
  return color_count
#print(color_count("white")) should be 28
colors = ['red','yellow','green','white','black','blue','purple']
for color in colors:
  print("You sold {} units of {} thread".format(color_count(color),color))
